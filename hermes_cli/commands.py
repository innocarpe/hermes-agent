...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("until-done", "Run a goal with explicit completion criteria until done or blocked", "Session",
               aliases=("ud",), args_hint="<goal>"),
    CommandDef("goal-status", "Show the status of the current or most recent goal-until-done run", "Session",
               args_hint="[run_id]"),
    CommandDef("goal-stop", "Request stop for the current or specified goal-until-done run", "Session",
               args_hint="[run_id]"),
    CommandDef("goal-resume", "Resume a stopped or approval-blocked goal-until-done run", "Session",
               args_hint="[run_id]"),
    CommandDef("goal-list", "List tracked goal-until-done runs", "Session"),
